...
| `~/.claude/devbox-agent/teams_bridge.js` | Main bridge script |
| `~/.claude/devbox-agent/start-agent.bat` | Launcher — double-click to run |
| `~/.claude/devbox-agent/bridge.log` | Rolling log |
| `~/.claude/devbox-agent/pa-flow-1-teams-to-onedrive.json` | PA Flow 1 reference |
| `~/.claude/devbox-agent/pa-flow-2-onedrive-to-teams.json` | PA Flow 2 reference |
